...
> mechanism active if serving EU users, data retention procedures documented.
> Legal review recommended before first paying user.

---

## Universal items

### [COM-001] Privacy Policy published and accessible
...
### [COM-002] Terms of Service published covering acceptable use and payment terms
...
### [COM-003] Cookie consent mechanism active (if using tracking cookies)
...
### [COM-004] User data deletion mechanism implemented
...
### [COM-005] Data retention policy documented and implemented
