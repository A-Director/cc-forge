...
description: >
  Generates status/dashboard.html — a single self-contained HTML view of
  backlog completion, risks, decisions, and Hermes framework usage.
  Markdown stays source of truth; the dashboard is a read-only
  regeneratable view. Run after phase transitions, mid-project sanity
